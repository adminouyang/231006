...
FOFA_URLS = {
    "https://fofa.info/result?qbase64=InVkcHh5IiAmJiByZWdpb249ImFuaHVpIiAmJiBvcmc9IkNoaW5hbmV0IiAmJiBwcm90b2NvbD0iaHR0cCI%3D": "ip.txt",
}
HEADERS = {
...
def push_all_files():
    ...
    os.system("git add py/fofa/计数.txt")
